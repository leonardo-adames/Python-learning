<div align="center">
    <kbd>
        ...
        <img width="2064" height="100%" alt="Image" src="../../notes/resources/INTRO/Py_welcome3.png" altº="Image" width="100%"/>
    </kbd>
    <br>
    <br>
...
Sin embargo, aunque su popularidad y auge es relativamente reciente, como lenguaje de programación es de los que más tiempo lleva con nosotros.
...
<img src="https://imgs.search.brave.com/cm_7Kwui-vi72nR1DvbImpsLizZA5GWzrN9EXyf8sXU/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/dGhlZmFtb3VzcGVv/cGxlLmNvbS9wcm9m/aWxlcy90aHVtYnMv/Z3VpZG8tdmFuLXJv/c3N1bS00LmpwZw" width="256" height="256" alt="Guido van Rossum" align="left">Python fue creado por **`Guido van Rossum`** a finales de los años 80 en los Países Bajos. **Van Rossum** comenzó a trabajar en Python como un proyecto paralelo mientras estudiaba en **`CWI`**. Python fue concebido como un sucesor del lenguaje de programación ABC, que Van Rossum había trabajado anteriormente.
...
Python 1.0 fue lanzado en enero de 1994. Esta versión consolidó muchas de las características que se encontraban en la versión 0.9.0 y presentó nuevas funcionalidades, incluyendo:<br><br>


    Comprensión de listas.

    Soporte para módulos de extensión.<br>
...
## P**ython 2.x `2000-2010`**

**`Python 2.0`**, lanzado en octubre de 2000, marcó el inicio de una nueva era para el lenguaje. Esta versión trajo mejoras significativas y nuevas características, incluyendo:<br><br>
    ...
    Python 2.x continuó evolucionando con nuevas versiones a lo largo de la década, incluyendo Python 2.

    1, 2.2, 2.3, 2.4, 2.5, 2.6 y 2.7. Esta última versión, Python 2.7, fue lanzada en julio de 2010 y fue la última de la serie 2.x, con soporte extendido hasta 2020.
<br><br>
...
Desde el lanzamiento de Python 3.0, ha habido una serie de versiones importantes.<br><br>

---

## **Versiones `Python 3.x`**

Cada una de estas versiones ha traído mejoras y nuevas características, como:<br><br>
    ...
    Python 3.11: Enfocada en mejoras de rendimiento y optimización del lenguaje.<br><br>
